...
class ViewController: UIViewController {
    ...
    @IBAction func buttonPressed(_ sender: UIButton) {
        if sender.tag == 1  && storyIndex == 1 {
            updateUI(title: story3, answerA: answer3a, answerB: answer3b)
            storyIndex = 3
        } else if sender.tag == 2 && storyIndex == 1 {
            updateUI(title: story2, answerA: answer2a, answerB: answer2b)
            storyIndex = 2
    ...
    func updateUI(title:String, answerA:String, answerB:String) {
