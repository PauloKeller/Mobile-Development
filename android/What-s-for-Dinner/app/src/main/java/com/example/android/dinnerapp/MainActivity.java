...
public class MainActivity extends Activity {
    ...
    public void startShowDailySpecialActivity(){
        ...
        // Get the food pref out of the data layer
    ...
    public void loadGTMContainer() {
        ...
        // Load the Container
        PendingResult pending = mTagManager.loadContainerPreferFresh("GTM-MW6VM7W", R.raw.gtm_default);
        ...
        pending.setResultCallback(new ResultCallback<ContainerHolder>() {
            ...
            public void onResult(ContainerHolder containerHolder) {
                ...
                // Can only do this once every minute
