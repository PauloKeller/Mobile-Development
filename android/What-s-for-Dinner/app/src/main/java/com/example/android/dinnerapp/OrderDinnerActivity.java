...
public class OrderDinnerActivity extends Activity {
    ...
    public void addDinnerToCart(View view){
        // Code goes here to add the dinner cart
        ...
        // Hide this refund button
        button = (Button) findViewById(R.id.refund_btn);
        button.setVisibility(View.INVISIBLE);
    }
    ...
    public void startCheckout(View view) {
        ...
        // Show the start checkout payment button
        Button button = (Button) findViewById(R.id.start_checkout_payment_btn);
        button.setVisibility(View.VISIBLE);

        // Hide this checkout button
    ...
    public void getPaymentInfo(View view) {
        ...
        // Hide this checkout button
        button = (Button) findViewById(R.id.start_checkout_payment_btn);
        button.setVisibility(View.INVISIBLE);
    }
    ...
    // We are faking the cart
    // Assume that the currently selected dinner is in the cart
    public void sendPaymenteInfoHit() {
        Product product = new Product()
                .setName("dinner")
                .setPrice(5)
                .setVariant(thisDinner)
    ...
    public void sendPurchaseHit() {
        ...
        String transactionID = Utility.getUniqueTransactionId(thisDinnerId);
    ...
    public void refund (View view) {
        // Code goes here to add the dinner cart
        // do not implement now!
        Utility.showMyToast("Refund dinner " + thisDinner, this);
